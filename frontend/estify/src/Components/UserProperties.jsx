      ...
      <div className="mb-10 flex flex-col items-center gap-4">
        ...
        <div className="flex gap-6">
          <div className="text-center">
            <label className="block font-medium text-gray-700">Min Price (LKR)</label>
            <input
              type="number"
              value={minPrice === 0 ? "" : minPrice}
              onChange={(e) => setMinPrice(Number(e.target.value) || 0)}
              className="border p-2 rounded w-32 shadow-sm"
              placeholder="Any"
            />
          </div>
          <div className="text-center">
            <label className="block font-medium text-gray-700">Max Price (LKR)</label>
            <input
              type="number"
