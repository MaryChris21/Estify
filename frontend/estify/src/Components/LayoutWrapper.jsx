      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <header className="z-50 flex justify-between items-center px-10 py-4 bg-white/80 backdrop-blur border-b border-gray-200 shadow-md">
          ...
          <div className="flex items-center gap-6">
            ...
            <button onClick={() => navigate("/properties")} className="text-sm font-medium hover:text-green-700 transition">Properties</button>
            <button onClick={() => navigate("/agent-login")} className="text-sm font-medium hover:text-green-700 transition">About Us</button>
