...
const ValuationTool = () => {
    ...
    return (
        <LayoutWrapper>
    <div className="relative min-h-screen flex items-center justify-center bg-cover bg-center bg-no-repeat mt-20 mb-32"
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
                ...
                <select
                    ...
                    className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 disabled:bg-gray-200"
                >
