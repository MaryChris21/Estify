...
const Register = () => {
  ...
  return (
    ...
    >
      ...
      {/* Register form card */}
      <div className="relative z-10 container max-w-lg px-8 py-10 bg-white rounded-lg shadow-xl w-full">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className={`bg-green-600 text-white p-2 rounded w-full hover:bg-green-700 ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
            disabled={loading}
          >
        ...
        {successModal && (
          <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg shadow-xl p-8 w-96 text-center">
              ...
              <p className="text-lg text-gray-600 mt-2">Redirecting to the login page...</p>
            </div>
          </div>
        )}
      </div>
